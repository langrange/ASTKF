% funciton: PID and ASTKF＋PID 对比试验的 ASTKF＋PID
...
open('Model/KalmanandPid.mdl')  % open the kalman model

sim('KalmanandPid') ; % begin to execute the simulink model
...
%% 精跟踪误差
figure('NumberTitle','off','Name','ASTKF+PID精跟踪误差');
fix_figure % Set up as standard EPS format
